...
class npAssetsOptimizerService
{
    ...
    public function replaceJavascripts(sfWebResponse $response)
    {
        ...
        $options = ($this->configuration['javascript']['params']['absolute']) ? array("absolute" => true) : array();
    ...
    public function replaceStylesheets(sfWebResponse $response)
    {
        ...
        $options = ($this->configuration['stylesheet']['params']['absolute']) ? array("absolute" => true) : array();
